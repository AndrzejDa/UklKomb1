...
HD_PWD='D:/XilinxProjekty/UklKomb1/UklKomb1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log UklKomb1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source UklKomb1.tcl -notrace
