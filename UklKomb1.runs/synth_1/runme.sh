...
HD_PWD='D:/XilinxProjekty/UklKomb1/UklKomb1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UklKomb1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UklKomb1.tcl
